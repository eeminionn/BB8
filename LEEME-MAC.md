...
**T** abre y cierra la entrada de texto; Enter (también el numérico) envía y Escape cierra. T queda reservada como atajo mientras escribes; para introducir texto que la contenga puedes pegarlo. Cerrar conserva el borrador. Un mensaje vacío o enviado mientras el servicio está ocupado permanece en el campo. **F3** muestra la interpretación estimada, permite cambiar de micrófono y comparar directamente Alegría 1, 2 y 3. El diagnóstico está oculto normalmente.
